...
RUN_NAME="check1800_v9_no_gate_tool_reward_merge_800_ablation_5gpu_interation10"
...
MODEL_BASE=/scratch/prj0000000262-bucket/ocr/ec/TimeSearch-R_latest/experiment/SFT_Video_R1_cyt_60_frame_hard/2026-02-01-22/checkpoint-400
...
torchrun --nproc_per_node=${NUM_GPUS} --nnodes=1 --node_rank=0 \
    ...
    --reward_func v9_no_gate_tool_reward_merge \
    --prompt_template v3 \
