...
mkdir -p $OUTPUT_DIR
export WANDB_PROJECT=timesearch-R-validation-VIDEO-R1-COT
...
export NCCL_TIMEOUT="7200"  # 设置为 2 小时 (默认是 1800 秒)
export TORCH_NCCL_BLOCKING_WAIT="1"  # 可选：强制阻塞等待，防止异步报错干扰
NUM_GPUS=8
MASTER_PORT=29500
