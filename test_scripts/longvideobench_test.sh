...
torchrun \
    ...
    --input_path /scratch/prj0000000262-bucket/ocr/ec/jsonfolder/LVB_all_id_cyt.json \
    --save_path /scratch/prj0000000262-bucket/ocr/ec/TimeSearch-R_latest/test/LVB/sft_3000 \
