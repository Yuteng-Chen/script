...
python time_r1/test_data.py \
    --input_path /xuhongbo/shuimu.chen/COT_active/activitynet_final_raw_xuhongbo.json \
    --save_path /xuhongbo/shuimu.chen/COT_active/activitynet_final_raw_xuhongbo_COT.json \
    --data_root /xuhongbo/shuimu.chen/LongVideoBench/videos_480p_noaudio \
    --model_base /xuhongbo/shuimu.chen/qwen2.5vl-Instruct-72b \
    --prompt_template v3 \
    --use_env True \
    --use_vllm True \
